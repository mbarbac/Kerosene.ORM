...
namespace Kerosene.ORM.Maps.Concrete
{
	...
	public static partial class ProxyGenerator
	{
		...
		public static void OnProxySetter(object entity, object value, string name)
		{
			...
			var holder = Holders.FindByExtendedType(type);
			var lazy = holder.LazyProperties.FindByLazyName(name);
	...
	public class ProxyHolder
	{
		...
		{
			LazyProperties = new LazyPropertySet();
		}
		...
		/// </summary>
		internal LazyPropertySet LazyProperties { get; private set; }
	}
