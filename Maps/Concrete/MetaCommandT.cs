...
namespace Kerosene.ORM.Maps.Concrete
{
	...
	/// </summary>
	internal interface IUberCommand : IMetaCommand, IDisposableEx
	{
		/// <summary>
	...
	public abstract class MetaCommand<T> : IMetaCommand<T>, IUberCommand where T : class
	{
		...
		public string TraceString()
		{
			...
			var temp = IsDisposed
				...
				: (cmd == null
					? string.Format("empty::{0}({1})", GetType().EasyName(), OnTraceStringCommandEmpty())
					: str);
		...
		/// </summary>
		protected virtual string OnTraceStringCommandEmpty() { return string.Empty; }
	}
}
// ======================================================== 
