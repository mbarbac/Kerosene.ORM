...
namespace Kerosene.ORM.Maps.Concrete
{
	...
	public class MapMemberCollection<T>
		: IMapMemberCollection<T>, IEnumerable<MapMember<T>>
		, IUberMemberCollection where T : class
	{
		DataMap<T> _Map = null;
		...
		/// </summary>
		internal MapMember<T> Find(Predicate<MapMember<T>> match)
		{
		...
		/// </summary>
		internal List<MapMember<T>> FindAll(Predicate<MapMember<T>> match)
		{
