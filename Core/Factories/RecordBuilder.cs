namespace Kerosene.ORM.Core
{
	...
	/// </summary>
	public class RecordBuilder : DynamicObject, IDisposableEx, IElementAliasCollectionProvider
	{
		bool _IsDisposed = false;
		bool _CaseSensitiveNames = Schema.DEFAULT_CASESENSITIVE_NAMES;
		...
		public object this[string column]
		{
			get
			{
				...
				var entry = _Schema.FindEntry(column, raise: true);
				if (entry == null) throw new NotFoundException(
